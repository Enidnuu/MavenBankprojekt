...
public class Sparbuch extends Konto {
	...
	*/
	...
	/**
	 * erweitert die Waehrungswechsel-Methode, sodass auch bereitsAbgehoben der neuen Waehrung angepasst wird
	 *
	 * @param waehrung die neue fuehrende Waehrung
	 */
	@Override
	public void waehrungswechsel(Waehrung waehrung){
		double temp = getAktuelleWaehrung().waehrungInEuroUmrechnen(bereitsAbgehoben);
		double temp2 = waehrung.euroInWaehrungUmrechnen(temp);
		this.bereitsAbgehoben = temp2;
