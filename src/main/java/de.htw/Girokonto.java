...
public class Girokonto extends Konto implements Ueberweisungsfaehig{
	...
	/**
	 * erweitert die Waehrungswechsel-Methode, sodass auch dispo der neuen Waehrung angepasst wird
	 *
	 * @param waehrung die neue fuehrende Waehrung
	 */
	@Override
	public void waehrungswechsel(Waehrung waehrung){
		double temp = getAktuelleWaehrung().waehrungInEuroUmrechnen(getDispo());
